...
namespace ConcediuAngajati.Controllers
{
    ...
    public class AngajatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AngajatId,Nume,Prenume,DataNastere,Functie,InConcediu")] Angajat angajat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AngajatId,Nume,Prenume,DataNastere,Functie,InConcediu")] Angajat angajat)
        {
        ...
        public async Task<IActionResult> ViewHolidays(int id)
        {
            var angajat = await _context.Angajati.FindAsync(id);

            return View(await _context.AngajatiConcedii.Where((m => m.AngajatConcediuId == angajat.AngajatId)).ToListAsync());
        }
    }
}
